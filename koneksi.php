...
if ($row_produk['jumlah'] == 0) {
  mysqli_query($conn, "
    ...
    ('Produk 1', 35000, 'gambar/CashSoft Crop Cardigan.jpg'),
    ('Produk 2', 35000, 'gambar/download (1).jpg'),
    ('Produk 3', 35000, 'gambar/download (2).jpg'),
    ('Produk 4', 35000, 'gambar/download (3).jpg'),
    ('Produk 5', 35000, 'gambar/download.jpg'),
    ('Produk 6', 35000, 'gambar/Next CREW NECK - Adīta jaka - yellow.jpg'),
    ('Produk 7', 35000, 'gambar/Reiss Amelia Cardigan.jpg'),
    ('Produk 8', 35000, 'gambar/Siola ribbed-trim cardigan - Pink.jpg')
  ");
}
